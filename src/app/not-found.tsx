...
export default function NotFound() {
  return (
    <section className="container-wide py-32 text-center">
      <h1 className="font-heading font-extrabold text-4xl md:text-6xl text-soft">Page not found</h1>
      <p className="mt-6 text-platinum">The page you're looking for doesn't exist or has moved.</p>
      <Link
        href="/"
