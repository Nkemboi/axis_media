  ...
  return (
    <>
      <section className="container-wide pt-20 pb-16">
        <h1 className="font-heading font-extrabold text-4xl md:text-6xl text-soft max-w-3xl">
      ...
      <section className="bg-slate-900 py-20">
        <div className="container-wide grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="font-heading font-bold text-2xl text-soft mb-4">Our mission</h2>
            <p className="text-platinum text-sm md:text-base leading-relaxed">
          ...
          <div>
            <h2 className="font-heading font-bold text-2xl text-soft mb-4">Our vision</h2>
            <p className="text-platinum text-sm md:text-base leading-relaxed">
      ...
      <section className="container-wide py-20">
        <h2 className="font-heading font-bold text-2xl md:text-3xl text-soft mb-10">What we stand for</h2>
        <div className="flex flex-wrap gap-3">
          {values.map((value) => (
            <span key={value} className="text-sm px-5 py-2.5 rounded-full border border-white/10 bg-slate-900 text-platinum">
              {value}
            </span>
          ))}
        </div>
