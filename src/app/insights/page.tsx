  ...
  return (
    <>
      <section className="container-wide pt-20 pb-16">
        <h1 className="font-heading font-extrabold text-4xl md:text-6xl text-soft max-w-3xl">Insights</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {posts.map((post) => (
            ...
            >
              ...
              <h2 className="font-heading font-semibold text-soft text-lg">{post.title}</h2>
